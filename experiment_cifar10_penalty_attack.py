...
{'model': 'WangL2WRN-28-10','attack':'ALMA','p_norm':'l2','init_lr_dist':0.1,'batch_size':batch_size ,'iter_num':1000},
...
{'model': 'WangL2WRN-28-10','attack':'ALMA','p_norm':'l1','init_lr_dist':0.5,'batch_size':batch_size ,'iter_num':1000},
...
for item in list_para:
    ...
    if 'PenaltyAttack' in item['attack']:
        ...
        torch.save(dict_save,'./result/cifar10-first1000/{}_attack_{}_pnorm{}_iternum{}_initlr{}.pt'.format(item['model'], item['attack'],item['p_norm'], item['iter_num'],item['init_lr_dist']))

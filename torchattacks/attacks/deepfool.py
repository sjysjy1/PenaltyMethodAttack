...
class DeepFool(Attack):
    ...
    def forward(self, images, labels):
        ...
        Overridden.
        """
        adv_images, target_labels,curr_steps = self.forward_return_target_labels(images, labels) #sunjiyuan
        return adv_images, curr_steps,target_labels  #sunjiyuan
    ...
    def forward_return_target_labels(self, images, labels):
        ...
        return adv_images, target_labels, curr_steps

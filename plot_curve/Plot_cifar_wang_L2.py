...
WangL2_L2attack_ALMA=torch.load('../result/cifar10-first1000/WangL2WRN-28-10_attack_ALMA_pnorml2_iternum1000_initlr0.1.pt')
pert_list8=np.asarray(WangL2_L2attack_ALMA['list_pert'].cpu())
...
y8=[len(pert_list8[np.asarray(pert_list8<item) & np.asarray(WangL2_L2attack_ALMA['list_success_fail'].cpu())])/len(pert_list8) for item in x ]
